 ...
 * Template Name: Services3 Template
...
<h1><?php $page = get_post(98) ; echo $page->post_title; ?></h1>
</banner>

<section class="service-section">
<div class="col-sm-12 col-md-6">
<div class="image-service">
<img src="<?php $data = get_field('image',98); echo $data['url']; ?>" alt="">
</div>
</div>
<div class="col-sm-12 col-md-6">
...
<p>
<?php $page = get_post(98); echo $page->post_content; ?>
</p>
</div>
</div>
</div>
...
<div class="container">
<div class="theme-heading"><?php $page = get_post(98) ; echo $page->post_title; ?><span></span></div>
<div class="philosply-box">
<div class="row">
<?php  
            $args = array('post_type' => 'sub-services',
                          'meta_key' => 'main_service',
                          'meta_value' => 'Video Production'
                             
                          );
            $loop = new WP_Query( $args );
    while ( $loop->have_posts() )  : $loop->the_post(); $i=0; $i++;
?>

<div class="col-xs-12 col-sm-4">
<div class="philosphy-heading"><?php echo get_field( "title2", get_the_ID() ); ?></div>
<div class="philosphy-content"><?php echo  wp_trim_words( get_field( "content2", get_the_ID() ),100 ); ?></div>
</div>
