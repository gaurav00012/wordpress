...
<div class="page-title"><?php _e( 'Nothing Found', 'twentyfifteen' ); ?></div>
	...
	<div class="page-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<div class="entry-summary"><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'twentyfifteen' ); ?></div>
			<?php get_search_form(); ?>
